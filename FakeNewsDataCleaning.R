...
## Read in the Data
fakeNews.train <- read_csv("~/Desktop/Kaggle/FakeNews/train.csv")
fakeNews.test <- read_csv("~/Desktop/Kaggle/FakeNews/test.csv")
fakeNews <- bind_rows(train=fakeNews.train, test=fakeNews.test,
                      .id="Set")

clean <- vroom::vroom("~/Desktop/Kaggle/FakeNews/CleanFakeNews.csv")
...
############################################
## Calculate tf-idf for most common words ##
